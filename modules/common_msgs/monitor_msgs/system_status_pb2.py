...
_SYSTEMSTATUS_OTHERCOMPONENTSENTRY.has_options = True
_SYSTEMSTATUS_OTHERCOMPONENTSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
