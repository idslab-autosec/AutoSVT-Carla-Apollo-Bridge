...
class ImuSensor(Sensor):
    ...
    def __init__(self, uid, name, parent, relative_spawn_pose, node, carla_actor, synchronous_mode):
        ...
        self.imu_writer = node.new_writer(self.get_topic_prefix(), CorrectedImu, qos_depth=10)
        self.listen()
    ...
    def sensor_data_updated(self, carla_imu_measurement):
        ...
        imu_msg.header.CopyFrom(self.parent.get_msg_header(timestamp=carla_imu_measurement.timestamp))
        ...
        # logging.info("roll=%s, pitch=%s, yaw=%s",
        #              carla_imu_measurement.transform.rotation.roll,
        #              carla_imu_measurement.transform.rotation.pitch,
        #              carla_imu_measurement.transform.rotation.yaw)
