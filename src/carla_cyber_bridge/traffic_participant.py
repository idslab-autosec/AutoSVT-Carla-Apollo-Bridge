...
# from bridge.carla_bridge.carla_proto.proto.carla_geometry_pb2 import SolidPrimitive
# from bridge.carla_bridge.carla_proto.proto.carla_marker_pb2 import ColorRGBA, Marker, MarkerList
