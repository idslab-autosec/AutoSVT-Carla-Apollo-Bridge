...
# from bridge.carla_bridge.carla_proto.proto.carla_geometry_pb2 import Twist, Accel
...
def carla_velocity_to_cyber_velocity(carla_velocity):
    cyber_velocity = Point3D()
    cyber_velocity.x = carla_velocity.x
    cyber_velocity.y = -carla_velocity.y
    cyber_velocity.z = carla_velocity.z
    
    return cyber_velocity
...
def carla_transform_to_cyber_pose(carla_transform):
    ...
    """
    cyber_pose = Pose()
    carla_transform.rotation.yaw += 90 # HIT-IDS-Bridge
